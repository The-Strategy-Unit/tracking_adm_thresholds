/*
 ...
 This is the primary query for phase II of the project: national admission thresholds. 
 */
...
FROM UDAL_Warehouse.Reporting_MESH_ECDS.EC_Core_Monthly_Snapshot ec
  ...
  ON ec.[Der_Provider_Site_Code] = sites.[SITE_CODE]
WHERE 1 = 1
  AND [Der_EC_Arrival_Date_Time] >= '2019-04-01 00:00:00.000'
